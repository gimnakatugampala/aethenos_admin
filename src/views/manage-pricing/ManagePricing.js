          ...
          <Paper className="row">
            <div>
              <div className="d-flex justify-content-end ">
                <Button onClick={handleAllPricing} className="mx-1" variant="contained">
                  <AddIcon /> Save Prices
                </Button>
              </div>
              ...
              <div className="row my-3 border p-2 mx-1">
                ...
                <div className="col-md-3">
                  ...
                  <Form.Control
                    value={DTip}
                    onChange={(e) => setDTip(e.target.value)}
                    as="textarea"
                    rows={1}
                    type="text"
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      <Form.Control
                        value={USATip}
                        onChange={(e) => setUSATip(e.target.value)}
                        as="textarea"
                        rows={2}
                        type="text"
                        placeholder="Enter Tip"
                    ...
                    <td>
                      <Form.Control
                        value={USAminValue}
                        onChange={(e) => setUSAminValue(e.target.value)}
                        type="text"
                  ...
                  <tr>
                    ...
                    <td>
                      <Form.Control
                        value={minAustralia}
                        onChange={(e) => setminAustralia(e.target.value)}
                        type="text"
                    ...
                    <td>
                      <Form.Control
                        value={maxAustralia}
                        onChange={(e) => setmaxAustralia(e.target.value)}
                        type="text"
                    ...
                    <td>
                      <Form.Control
                        value={AusTip}
                        onChange={(e) => setAusTip(e.target.value)}
                        as="textarea"
                        rows={2}
                        type="text"
                        placeholder="Enter Tip"
                    ...
                    <td>
                      <Form.Control
                        value={AusminValue}
                        onChange={(e) => setAusminValue(e.target.value)}
                        type="text"
                        placeholder="Minimum Value"
                      />
                    </td>
                  ...
                  <tr>
                    ...
                    <td>
                      <Form.Control
                        value={BrazilTip}
                        onChange={(e) => setBrazilTip(e.target.value)}
                        as="textarea"
                        rows={2}
                        type="text"
                        placeholder="Enter Tip"
                    ...
                    <td>
                      <Form.Control
                        value={BrazilminValue}
                        onChange={(e) => setBrazilminValue(e.target.value)}
                        type="text"
                        placeholder="Minimum Value"
                      />
                    </td>
                  ...
                  <tr>
                    ...
                    <td>
                      <Form.Control
                        value={CanadaTip}
                        onChange={(e) => setCanadaTip(e.target.value)}
                        as="textarea"
                        rows={2}
                        type="text"
                        placeholder="Enter Tip"
                    ...
                    <td>
                      <Form.Control
                        value={CanadaminValue}
                        onChange={(e) => setCanadaminValue(e.target.value)}
                        type="text"
                        placeholder="Minimum Value"
                      />
                    </td>
                  ...
                  <tr>
                    ...
                    <td>
                      <Form.Control
                        value={ChileTip}
                        onChange={(e) => setChileTip(e.target.value)}
                        as="textarea"
                        rows={2}
                        type="text"
                        placeholder="Enter Tip"
                    ...
                    <td>
                      <Form.Control
                        value={ChileminValue}
                        onChange={(e) => setChileminValue(e.target.value)}
                        type="text"
                        placeholder="Minimum Value"
                      />
                    </td>
                  ...
                  <tr>
                    ...
                    <td>
                      <Form.Control
                        value={minColumbia}
                        onChange={(e) => setminColumbia(e.target.value)}
                        type="text"
                        placeholder="Min Price"
                      />
                    </td>
                    <td>
                      <Form.Control
                        value={maxColumbia}
                        onChange={(e) => setmaxColumbia(e.target.value)}
                        type="text"
                        placeholder="Max Price"
                      />
                    </td>
                    <td>
                      <Form.Control
                        value={ColumbiaTip}
                        onChange={(e) => setColumbiaTip(e.target.value)}
                        as="textarea"
                        rows={2}
                        type="text"
                        placeholder="Enter Tip"
                    ...
                    <td>
                      <Form.Control
                        value={ColumbiaMinValue}
                        onChange={(e) => setColumbiaMinValue(e.target.value)}
                        type="text"
                        placeholder="Minimum Value"
                      />
                    </td>
                  ...
                  <tr>
                    ...
                    <td>
                      <Form.Control
                        value={EgyptTip}
                        onChange={(e) => setEgyptTip(e.target.value)}
                        as="textarea"
                        rows={2}
                        type="text"
                        placeholder="Enter Tip"
                    ...
                    <td>
                      <Form.Control
                        value={EgyptminValue}
                        onChange={(e) => setEgyptminValue(e.target.value)}
                        type="text"
                        placeholder="Minimum Value"
                      />
                    </td>
                  ...
                  <tr>
                    ...
                    <td>
                      <Form.Control
                        value={EUTip}
                        onChange={(e) => setEUTip(e.target.value)}
                        as="textarea"
                        rows={2}
                        type="text"
                        placeholder="Enter Tip"
                    ...
                    <td>
                      <Form.Control
                        value={EUminValue}
                        onChange={(e) => setEUminValue(e.target.value)}
                        type="text"
                        placeholder="Minimum Value"
                      />
                    </td>
                  ...
                  <tr>
                    ...
                    <td>
                      <Form.Control
                        value={GBPTip}
                        onChange={(e) => setGBPTip(e.target.value)}
                        as="textarea"
                        rows={2}
                        type="text"
                        placeholder="Enter Tip"
                    ...
                    <td>
                      <Form.Control
                        value={GBPminValue}
                        onChange={(e) => setGBPminValue(e.target.value)}
                        type="text"
                        placeholder="Minimum Value"
                      />
                    </td>
                  ...
                  <tr>
                    ...
                    <td>
                      <Form.Control
                        value={minindonedia}
                        onChange={(e) => setminindonedia(e.target.value)}
                        type="text"
                        placeholder="Min Price"
                      />
                    </td>
                    <td>
                      <Form.Control
                        value={maxindonedia}
                        onChange={(e) => setmaxindonedia(e.target.value)}
                        type="text"
                        placeholder="Max Price"
                      />
                    </td>
                    <td>
                      <Form.Control
                        value={IndoTip}
                        onChange={(e) => setIndoTip(e.target.value)}
                        as="textarea"
                        rows={2}
                        type="text"
                        placeholder="Enter Tip"
                    ...
                    <td>
                      <Form.Control
                        value={IndominValue}
                        onChange={(e) => setIndominValue(e.target.value)}
                        type="text"
                        placeholder="Minimum Value"
                      />
                    </td>
                  ...
                  <tr>
                    ...
                    <td>
                      <Form.Control
                        value={IsrealTip}
                        onChange={(e) => setIsrealTip(e.target.value)}
                        as="textarea"
                        rows={2}
                        type="text"
                        placeholder="Enter Tip"
                    ...
                    <td>
                      <Form.Control
                        value={IsrealminValue}
                        onChange={(e) => setIsrealminValue(e.target.value)}
                        type="text"
                        placeholder="Minimum Value"
                      />
                    </td>
                  ...
                  <tr>
                    ...
                    <td>
                      <Form.Control
                        value={IndiaTip}
                        onChange={(e) => setIndiaTip(e.target.value)}
                        as="textarea"
                        rows={2}
                        type="text"
                        placeholder="Enter Tip"
                    ...
                    <td>
                      <Form.Control
                        value={IndiaminValue}
                        onChange={(e) => setIndiaminValue(e.target.value)}
                        type="text"
                        placeholder="Minimum Value"
                      />
                    </td>
                  ...
                  <tr>
                    ...
                    <td>
                      <Form.Control
                        value={JapanTip}
                        onChange={(e) => setJapanTip(e.target.value)}
                        as="textarea"
                        rows={2}
                        type="text"
                        placeholder="Enter Tip"
                    ...
                    <td>
                      <Form.Control
                        value={JapanminValue}
                        onChange={(e) => setJapanminValue(e.target.value)}
                        type="text"
                        placeholder="Minimum Value"
                      />
                    </td>
                  ...
                  <tr>
                    ...
                    <td>
                      <Form.Control
                        value={KoreaTip}
                        onChange={(e) => setKoreaTip(e.target.value)}
                        as="textarea"
                        rows={2}
                        type="text"
                        placeholder="Enter Tip"
                    ...
                    <td>
                      <Form.Control
                        value={KoreaminValue}
                        onChange={(e) => setKoreaminValue(e.target.value)}
                        type="text"
                        placeholder="Minimum Value"
                      />
                    </td>
                  ...
                  <tr>
                    ...
                    <td>
                      <Form.Control
                        value={MexicoTip}
                        onChange={(e) => setMexicoTip(e.target.value)}
                        as="textarea"
                        rows={2}
                        type="text"
                        placeholder="Enter Tip"
                    ...
                    <td>
                      <Form.Control
                        value={MexicominValue}
                        onChange={(e) => setMexicominValue(e.target.value)}
                        type="text"
                        placeholder="Minimum Value"
                      />
                    </td>
                  ...
                  <tr>
                    ...
                    <td>
                      <Form.Control
                        value={minMalaysia}
                        onChange={(e) => setminMalaysia(e.target.value)}
                        type="text"
                        placeholder="Min Price"
                      />
                    </td>
                    <td>
                      <Form.Control
                        value={maxMalaysia}
                        onChange={(e) => setmaxMalaysia(e.target.value)}
                        type="text"
                        placeholder="Max Price"
                      />
                    </td>
                    <td>
                      <Form.Control
                        value={MalaysiaTip}
                        onChange={(e) => setMalaysiaTip(e.target.value)}
                        as="textarea"
                        rows={2}
                        type="text"
                        placeholder="Enter Tip"
                    ...
                    <td>
                      <Form.Control
                        value={MalaysiaminValue}
                        onChange={(e) => setMalaysiaminValue(e.target.value)}
                        type="text"
                        placeholder="Minimum Value"
                      />
                    </td>
                  ...
                  <tr>
                    ...
                    <td>
                      <Form.Control
                        value={minNigeria}
                        onChange={(e) => setminNigeria(e.target.value)}
                        type="text"
                        placeholder="Min Price"
                      />
                    </td>
                    <td>
                      <Form.Control
                        value={maxNigeria}
                        onChange={(e) => setmaxNigeria(e.target.value)}
                        type="text"
                        placeholder="Max Price"
                      />
                    </td>
                    <td>
                      <Form.Control
                        value={NigeriaTip}
                        onChange={(e) => setNigeriaTip(e.target.value)}
                        as="textarea"
                        rows={2}
                        type="text"
                        placeholder="Enter Tip"
                    ...
                    <td>
                      <Form.Control
                        value={NigeriaminValue}
                        onChange={(e) => setNigeriaminValue(e.target.value)}
                        type="text"
                        placeholder="Minimum Value"
                      />
                    </td>
                  ...
                  <tr>
                    ...
                    <td>
                      <Form.Control
                        value={NorwayTip}
                        onChange={(e) => setNorwayTip(e.target.value)}
                        as="textarea"
                        rows={2}
                        type="text"
                        placeholder="Enter Tip"
                    ...
                    <td>
                      <Form.Control
                        value={NorwayminValue}
                        onChange={(e) => setNorwayminValue(e.target.value)}
                        type="text"
                        placeholder="Minimum Value"
                      />
                    </td>
                  ...
                  <tr>
                    ...
                    <td>
                      <Form.Control
                        value={PeruTip}
                        onChange={(e) => setPeruTip(e.target.value)}
                        as="textarea"
                        rows={2}
                        type="text"
                        placeholder="Enter Tip"
                    ...
                    <td>
                      <Form.Control
                        value={PeruminValue}
                        onChange={(e) => setPeruminValue(e.target.value)}
                        type="text"
                        placeholder="Minimum Value"
                      />
                    </td>
                  ...
                  <tr>
                    ...
                    <td>
                      <Form.Control
                        value={minPhilipine}
                        onChange={(e) => setminPhilipine(e.target.value)}
                        type="text"
                        placeholder="Min Price"
                      />
                    </td>
                    <td>
                      <Form.Control
                        value={maxPhilipine}
                        onChange={(e) => setmaxPhilipine(e.target.value)}
                        type="text"
                        placeholder="Max Price"
                      />
                    </td>
                    <td>
                      <Form.Control
                        value={PhilippinesTip}
                        onChange={(e) => setPhilippinesTip(e.target.value)}
                        as="textarea"
                        rows={2}
                        type="text"
                        placeholder="Enter Tip"
                    ...
                    <td>
                      <Form.Control
                        value={PhilippinesminValue}
                        onChange={(e) => setPhilippinesminValue(e.target.value)}
                        type="text"
                        placeholder="Minimum Value"
                      />
                    </td>
                  ...
                  <tr>
                    ...
                    <td>
                      <Form.Control
                        value={PolandTip}
                        onChange={(e) => setPolandTip(e.target.value)}
                        as="textarea"
                        rows={2}
                        type="text"
                        placeholder="Enter Tip"
                    ...
                    <td>
                      <Form.Control
                        value={PolandminValue}
                        onChange={(e) => setPolandminValue(e.target.value)}
                        type="text"
                        placeholder="Minimum Value"
                      />
                    </td>
                  ...
                  <tr>
                    ...
                    <td>
                      <Form.Control
                        value={minRomania}
                        onChange={(e) => setminRomania(e.target.value)}
                        type="text"
                        placeholder="Min Price"
                      />
                    </td>
                    <td>
                      <Form.Control
                        value={maxRomania}
                        onChange={(e) => setmaxRomania(e.target.value)}
                        type="text"
                        placeholder="Max Price"
                      />
                    </td>
                    <td>
                      <Form.Control
                        value={RomaniaTip}
                        onChange={(e) => setRomaniaTip(e.target.value)}
                        as="textarea"
                        rows={2}
                        type="text"
                        placeholder="Enter Tip"
                    ...
                    <td>
                      <Form.Control
                        value={RomaniaminValue}
                        onChange={(e) => setRomaniaminValue(e.target.value)}
                        type="text"
                        placeholder="Minimum Value"
                      />
                    </td>
                  ...
                  <tr>
                    ...
                    <td>
                      <Form.Control
                        value={RussiaTip}
                        onChange={(e) => setRussiaTip(e.target.value)}
                        as="textarea"
                        rows={2}
                        type="text"
                        placeholder="Enter Tip"
                    ...
                    <td>
                      <Form.Control
                        value={RussiaminValue}
                        onChange={(e) => setRussiaminValue(e.target.value)}
                        type="text"
                        placeholder="Minimum Value"
                      />
                    </td>
                  ...
                  <tr>
                    ...
                    <td>
                      <Form.Control
                        value={minSingapore}
                        onChange={(e) => setminSingapore(e.target.value)}
                        type="text"
                        placeholder="Min Price"
                      />
                    </td>
                    <td>
                      <Form.Control
                        value={maxSingapore}
                        onChange={(e) => setmaxSingapore(e.target.value)}
                        type="text"
                        placeholder="Max Price"
                      />
                    </td>
                    <td>
                      <Form.Control
                        value={SingaporeTip}
                        onChange={(e) => setSingaporeTip(e.target.value)}
                        as="textarea"
                        rows={2}
                        type="text"
                        placeholder="Enter Tip"
                    ...
                    <td>
                      <Form.Control
                        value={SingaporeminValue}
                        onChange={(e) => setSingaporeminValue(e.target.value)}
                        type="text"
                        placeholder="Minimum Value"
                      />
                    </td>
                  ...
                  <tr>
                    ...
                    <td>
                      <Form.Control
                        value={minThailand}
                        onChange={(e) => setminThailand(e.target.value)}
                        type="text"
                        placeholder="Min Price"
                      />
                    </td>
                    <td>
                      <Form.Control
                        value={maxThailand}
                        onChange={(e) => setmaxThailand(e.target.value)}
                        type="text"
                        placeholder="Max Price"
                      />
                    </td>
                    <td>
                      <Form.Control
                        value={ThailandTip}
                        onChange={(e) => setThailandTip(e.target.value)}
                        as="textarea"
                        rows={2}
                        type="text"
                        placeholder="Enter Tip"
                    ...
                    <td>
                      <Form.Control
                        value={ThailandminValue}
                        onChange={(e) => setThailandminValue(e.target.value)}
                        type="text"
                        placeholder="Minimum Value"
                      />
                    </td>
          ...
          <Form.Control value={TurkeyminValue} onChange={(e) => setTurkeyminValue(e.target.value)} type="text" placeholder="Minimum Value" />
                  ...
                  <tr>
                    ...
                    <td>
                      <Form.Control
                        value={TaiwanTip}
                        onChange={(e) => setTaiwanTip(e.target.value)}
                        as="textarea"
                        rows={2}
                        type="text"
                        placeholder="Enter Tip"
                    ...
                    <td>
                      <Form.Control
                        value={TaiwanminValue}
                        onChange={(e) => setTaiwanminValue(e.target.value)}
                        type="text"
                        placeholder="Minimum Value"
                      />
                    </td>
                  ...
                  <tr>
                    ...
                    <td>
                      <Form.Control
                        value={minVietnam}
                        onChange={(e) => setminVietnam(e.target.value)}
                        type="text"
                        placeholder="Min Price"
                      />
                    </td>
                    <td>
                      <Form.Control
                        value={maxVietnam}
                        onChange={(e) => setmaxVietnam(e.target.value)}
                        type="text"
                        placeholder="Max Price"
                      />
                    </td>
                    <td>
                      <Form.Control
                        value={VietnamTip}
                        onChange={(e) => setVietnamTip(e.target.value)}
                        as="textarea"
                        rows={2}
                        type="text"
                        placeholder="Enter Tip"
                    ...
                    <td>
                      <Form.Control
                        value={VietnamminValue}
                        onChange={(e) => setVietnamminValue(e.target.value)}
                        type="text"
                        placeholder="Minimum Value"
                      />
                    </td>
                  ...
                  <tr>
                    ...
                    <td>
                      <Form.Control
                        value={SATip}
                        onChange={(e) => setSATip(e.target.value)}
                        as="textarea"
                        rows={2}
                        type="text"
                        placeholder="Enter Tip"
                    ...
                    <td>
                      <Form.Control
                        value={SAminValue}
                        onChange={(e) => setSAminValue(e.target.value)}
                        type="text"
                        placeholder="Minimum Value"
                      />
                    </td>
