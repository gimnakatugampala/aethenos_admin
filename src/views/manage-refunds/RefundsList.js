    ...
    setTimeout(() => {
      ...
      RefundsData = refunds.map((refund,index) => {
        ...
        return { ...refund, 
          ...
          refunded:  (
            refund.status == "Approved" ? <Checkbox value={selectedCheckbox} onChange={(e) => handleTransferedAmount(e.target.checked, refund.refundCode)}
  ...
  return (
    ...
    <Modal show={Viewshow} onHide={handleCloseView}>
      ...
      <Box sx={{ display: 'flex', flexDirection: 'column' }}>
       ...
       <a className='m-2 w-75 mx-auto'  rel="noreferrer" target='_blank' href={`https://aethenos.com/users/${uD.userDetails.userCode}`}><Button variant="danger"><PeopleAltIcon /> View Student</Button></a>
